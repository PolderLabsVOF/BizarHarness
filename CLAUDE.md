...
>
> This file is what Claude Code reads at session start. It is kept in
> sync with `AGENTS.md` via `make mirror-agents-md`
> (`scripts/mirror-agents-md.sh`); edits should land in `AGENTS.md`
> first, then mirrored here. The mirror check fails CI when they
> diverge.
