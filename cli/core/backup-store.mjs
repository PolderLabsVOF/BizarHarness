/**
 * cli/core/backup-store.mjs
 *
 * v4.8.0 — Backup/restore core for BizarHarness state.
 *
 * Manages timestamped backup directories under
 * ~/.local/share/bizar/backups/ containing copies of Bizar config and project state. Each backup has a manifest.json
...
const PROJECT_BACKUP_PATHS = [
  ...
  { src: '.claude/skills/', label: 'project-skills', required: false },
...
/** Read Bizar version from package.json. */
