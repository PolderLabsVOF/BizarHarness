---
name: bizar-network-architect
description: Bizar-network-architect — Bizar specialist.
...
the focused Bizar network skills instead of inventing device-specific runbooks in
the agent prompt.
