---
name: bizar-react-build-resolver
description: Bizar-react-build-resolver — Bizar specialist.
isolation: worktree
...
- Skills: the relevant installed Bizar skill, when available, the relevant installed Bizar skill, when available
