...
- When uncertain or stuck, reach for `websearch` / `webfetch` (or `semble search` for repository context) before trying a third variation of the same edit — see `uncertainty.md`