...
// Static alias policy: research lanes default to `sonnet`. The plan
// auditor and final verifier escalate to `opus`. Callers may override
// with `opts.model` for any explicit per-lane escalation.
