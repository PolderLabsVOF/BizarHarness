...
// Static alias policy: research and implementation lanes default to
// `sonnet`. The plan auditor and final verifier escalate to `opus`.
...
const TASK = typeof args === 'string' ? args : args?.task || String(args || '')
