there were issues with the opencode config that caused opencode to not start. i fixed them now by removing the incompatible stuff. check what changed and make sure you dont mess up the config with incompatible keys and values and stuff.
...
- make lightrag default to free opencode models. 
...
- i cant open an opencode session in the dash chat. 
...
- do a full overhaul of the chat functinality and how it works. it needs to work smooth and perfect. make sure its well integrated with opencode.
