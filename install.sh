...
echo -e "${BOLD}${CYAN}│${NC}  Odin     🛡️  DeepSeek V4 Flash Free  Free                   │"
echo -e "${BOLD}${CYAN}│${NC}  Heimdall 👁️  DeepSeek V4 Flash Free  Free                   │"
echo -e "${BOLD}${CYAN}│${NC}  Thor     ⚡  MiniMax M2.7           \$0.30/\$1.20              │"
echo -e "${BOLD}${CYAN}│${NC}  Tyr      ⚖️  MiniMax M3             Highest                  │"
